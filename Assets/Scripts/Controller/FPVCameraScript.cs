...
public class FPVCameraScript : MonoBehaviour {
	...
	void Update () {
		transform.position = Communication.droneRb.transform.position + Communication.droneRb.transform.rotation * offset;

		Vector3 euler = Communication.droneRb.transform.rotation.eulerAngles;
